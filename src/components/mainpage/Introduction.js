      ...
      <div className="introduction-content">
        ...
        <div className={`info-box ${theme === 'dark' ? 'info-box-dark' : ''}`}>
          <p>
            ...
            一般開放はしない予定ですので、もし入りたい方がいらっしゃいましたら<a href="https://url.kamedayo.com/twitter">X(旧Twitter)</a>もしくは<a href="https://url.kamedayo.com/misskey">Misskey.io</a>にDMください<br />
